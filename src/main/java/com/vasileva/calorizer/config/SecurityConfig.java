...
import com.vasileva.calorizer.config.jwt.JwtAuthenticationFilter;
...
//    }
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setExposedHeaders(List.of("Authorization")); // Чтобы фронтенд видел заголовки ответа
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/food-list").permitAll()
